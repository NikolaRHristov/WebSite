...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<table>${renderComponent($$result2, "Heading", $$Heading, { "DarkIcon": "https://nikolahristov.tech/Dark/Image/GitHub/Astro.svg", "LightIcon": "https://nikolahristov.tech/Image/GitHub/Astro.svg", "Text": "Related\u2003\u2014", "AltIcon": "Astro" })}${renderComponent($$result2, "Row", $$Row, { "Package": /* @__PURE__ */ new Set(["NPM:@playform/inline", "NPM:@playform/format"]) })}</table>` })}`;
...
//# sourceMappingURL=index_zYBKb56q.mjs.map
