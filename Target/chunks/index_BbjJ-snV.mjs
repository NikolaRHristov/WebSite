...
import 'kleur/colors';
import { $ as $$Cargo$1 } from './Cargo_E-GbTbpv.mjs';
...
}, "D:/Developer/Application/NikolaRHristov/Website/Source/Component/Readme/CodeEditorLand/Foundation/OXC/Cargo.astro", void 0);

const $$Astro = createAstro("https://nikolahristov.tech/");
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Cargo", $$Cargo, {})}${maybeRenderHead()}<a href="https://fossa.app/projects/git%2Bgithub.com%2FCodeEditorLand%2FFoundationOXCCargo?ref=badge_large&issueType=license"><img src="https://fossa.app/api/projects/git%2Bgithub.com%2FCodeEditorLand%2FFoundationOXCCargo.svg?type=large&issueType=license" alt="FOSSA Status"></a>` })}`;
...
const $$file = "D:/Developer/Application/NikolaRHristov/Website/Source/pages/Raw/Readme/CodeEditorLand/FoundationOXCCargo/index.astro";
const $$url = "/Raw/Readme/CodeEditorLand/FoundationOXCCargo";

export { $$Index as default, $$file as file, $$url as url };
//# sourceMappingURL=index_BbjJ-snV.mjs.map
