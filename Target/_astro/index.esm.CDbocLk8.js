 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Ue(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Ue(t){const e=t.getComponent();return e?.type==="VERSION"}const C="@firebase/app",$="0.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rt(t){P(new S("platform-logger",e=>new ke(e),"PRIVATE")),P(new S("heartbeat",e=>new Bt(e),"PRIVATE")),b(C,$,t),b(C,$,"esm2017"),b("fire-js","")}Rt("");var Mt="firebase",Nt="10.10.0";/**
 * @license
...
//# sourceMappingURL=index.esm.CDbocLk8.js.map
