	...
	Y = {
		...
		encodeByteArray(t, e) {
			...
			for (let r = 0; r < t.length; r += 3) {
				...
				let I = ((c & 15) << 2) | (h >> 6),
					w = h & 63;
				o || ((w = 64), a || (I = 64)), s.push(n[D], n[u], n[I], n[w]);
			}
			return s.join("");
		},
		encodeString(t, e) {
		...
		decodeStringToByteArray(t, e) {
			...
			for (let r = 0; r < t.length; ) {
				...
				if ((++r, i == null || c == null || h == null || u == null))
					throw new ce();
				const I = (i << 2) | (c >> 4);
				if ((s.push(I), h !== 64)) {
					const w = ((c << 4) & 240) | (h >> 2);
 ...
 * limitations under the License.
 */
const fe = () => de().__FIREBASE_DEFAULTS__,
	ue = () => {
	...
	Z = () => {
		var t;
		return (t = me()) === null || t === void 0 ? void 0 : t.config;
	}; /**
 * @license
 * Copyright 2017 Google LLC
 *
...
function Re(t, e) {
	for (const n of H) {
		let s = null;
		e && e.level && (s = ee[e.level]),
			t === null
				? (n.userLogHandler = null)
				: (n.userLogHandler = (r, i, ...a) => {
						const c = a
							.map((o) => {
...
function Ne() {
	return (
		z ||
		(z = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])
	);
}
function Le() {
	return (
...
function $e(t) {
	...
	return (
		e
			.then((n) => {
				n instanceof IDBCursor && te.set(n, t);
			})
			.catch(() => {}),
		F.set(e, t),
		e
...
let L = {
	get(t, e, n) {
		if (t instanceof IDBTransaction) {
			if (e === "done") return N.get(t);
			if (e === "objectStoreNames")
				return t.objectStoreNames || ne.get(t);
			if (e === "store")
...
function Fe(t) {
	return t === IDBDatabase.prototype.transaction &&
		...
		? function (e, ...n) {
				const s = t.call(O(this), e, ...n);
				return ne.set(s, e.sort ? e.sort() : [e]), f(s);
			}
		: Le().includes(t)
			? function (...e) {
					return t.apply(O(this), e), f(te.get(this));
				}
			: function (...e) {
...
function xe(t) {
	return typeof t == "function"
		? Fe(t)
		: (t instanceof IDBTransaction && Pe(t),
			Me(t, Ne()) ? new Proxy(t, L) : t);
}
function f(t) {
	if (t instanceof IDBRequest) return $e(t);
	if (B.has(t)) return B.get(t);
	const e = xe(t);
	return e !== t && (B.set(t, e), F.set(e, t)), e;
}
const O = (t) => F.get(t);
function je(t, e, { blocked: n, upgrade: s, blocking: r, terminated: i } = {}) {
	const a = indexedDB.open(t, e),
		c = f(a);
	return (
		s &&
			a.addEventListener("upgradeneeded", (o) => {
				s(f(a.result), o.oldVersion, o.newVersion, f(a.transaction), o);
			}),
		n &&
...
He((t) => ({
	...t,
	get: (e, n, s) => k(e, n) || t.get(e, n, s),
	has: (e, n) => !!k(e, n) || t.has(e, n),
})); /**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const m = new Oe("@firebase/app"),
	We = "@firebase/app-compat",
	Ge = "@firebase/analytics-compat",
	Je = "@firebase/analytics",
	Ke = "@firebase/app-check-compat",
	Ye = "@firebase/app-check",
	Xe = "@firebase/auth",
	Ze = "@firebase/auth-compat",
...
function P(t) {
	...
	if (E.has(e))
		return (
			m.debug(`There were multiple attempts to register component ${e}.`),
			!1
		);
	E.set(e, t);
...
class yt extends re {
	constructor(e, n, s, r) {
		const i =
				n.automaticDataCollectionEnabled !== void 0
					? n.automaticDataCollectionEnabled
					: !1,
			a = { name: s, automaticDataCollectionEnabled: i };
		if (e.apiKey !== void 0) super(e, a, r);
		else {
			const c = e;
			super(c.options, a, r);
		}
	...
	incRefCount(e) {
		this.isDeleted ||
			(this._refCount++,
			e !== void 0 && this._finalizationRegistry.register(e, this));
	}
	decRefCount() {
	...
	checkDestroyed() {
		if (this.isDeleted) throw d.create("server-app-deleted");
	}
} /**
 * @license
 * Copyright 2019 Google LLC
...
function vt(t, e = {}) {
	...
	const s = Object.assign({ name: A, automaticDataCollectionEnabled: !1 }, e),
		r = s.name;
	if (typeof r != "string" || !r)
		throw d.create("bad-app-name", { appName: String(r) });
	if ((n || (n = Z()), !n)) throw d.create("no-options");
	const i = g.get(r);
	if (i) {
		if (M(n, i.options) && M(s, i.config)) return i;
		throw d.create("duplicate-app", { appName: r });
	}
	const a = new q(r);
	for (const o of E.values()) a.addComponent(o);
	const c = new re(n, s, a);
	return g.set(r, c), c;
}
function xt(t, e) {
	if (be()) throw d.create("invalid-server-app-environment");
	e.automaticDataCollectionEnabled === void 0 &&
		(e.automaticDataCollectionEnabled = !1);
	let n;
	_t(t) ? (n = t.options) : (n = t);
	const s = Object.assign(Object.assign({}, e), n);
	s.releaseOnDeref !== void 0 && delete s.releaseOnDeref;
	const r = (h) =>
		[...h].reduce((D, u) => (Math.imul(31, D) + u.charCodeAt(0)) | 0, 0);
	if (e.releaseOnDeref !== void 0 && typeof FinalizationRegistry > "u")
		throw d.create("finalization-registry-not-supported", {});
	const i = "" + r(JSON.stringify(s)),
		a = _.get(i);
	if (a) return a.incRefCount(e.releaseOnDeref), a;
	const c = new q(i);
	for (const h of E.values()) c.addComponent(h);
	const o = new yt(n, e, i, c);
	return _.set(i, o), o;
}
function jt(t = A) {
	const e = g.get(t);
	if (!e && t === A && Z()) return vt();
...
async function Dt(t) {
	...
	g.has(n)
		? ((e = !0), g.delete(n))
		: _.has(n) && t.decRefCount() <= 0 && (_.delete(n), (e = !0)),
		e &&
			(await Promise.all(
				t.container.getProviders().map((s) => s.delete()),
			),
			(t.isDeleted = !0));
}
function b(t, e, n) {
	...
	P(new S(`${r}-version`, () => ({ library: r, version: e }), "VERSION"));
}
function Vt(t, e) {
...
async function St(t) {
	try {
		const n = (await se()).transaction(y),
			s = await n.objectStore(y).get(ie(t));
		return await n.done, s;
	} catch (e) {
		if (e instanceof v) m.warn(e.message);
		else {
...
async function W(t, e) {
	try {
		const s = (await se()).transaction(y, "readwrite");
		await s.objectStore(y).put(e, ie(t)), await s.done;
	} catch (n) {
		if (n instanceof v) m.warn(n.message);
		else {
...
class Bt {
	...
	async getHeartbeatsHeader() {
		...
		if (
			...
			return "";
		const n = G(),
			{ heartbeatsToSend: s, unsentEntries: r } = Ot(
				this._heartbeatsCache.heartbeats,
			),
			i = X(JSON.stringify({ version: 2, heartbeats: s }));
		return (
...
function Ot(t, e = Ct) {
	...
	for (const r of t) {
		...
		if (i) {
			if ((i.dates.push(r.date), J(n) > e)) {
				i.dates.pop();
				break;
			}
		} else if ((n.push({ agent: r.agent, dates: [r.date] }), J(n) > e)) {
			n.pop();
			break;
		}
		s = s.slice(1);
...
function J(t) {
	return X(JSON.stringify({ version: 2, heartbeats: t })).length;
} /**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 */
function Rt(t) {
	P(new S("platform-logger", (e) => new ke(e), "PRIVATE")),
		P(new S("heartbeat", (e) => new Bt(e), "PRIVATE")),
		b(C, $, t),
		b(C, $, "esm2017"),
		b("fire-js", "");
}
...
export {
	v as FirebaseError,
	Ft as SDK_VERSION,
	A as _DEFAULT_ENTRY_NAME,
	U as _addComponent,
	Lt as _addOrOverwriteComponent,
	g as _apps,
	Ht as _clearComponents,
	E as _components,
	bt as _getProvider,
	_t as _isFirebaseApp,
	Pt as _isFirebaseServerApp,
	P as _registerComponent,
	$t as _removeServiceInstance,
	_ as _serverApps,
	Dt as deleteApp,
	jt as getApp,
	zt as getApps,
	vt as initializeApp,
	xt as initializeServerApp,
	Vt as onLog,
	b as registerVersion,
	kt as setLogLevel,
};
