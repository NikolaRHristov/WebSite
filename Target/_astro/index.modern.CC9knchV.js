...
import { Location as c, getCurrentUrl as L } from "./Swup.modern.QWtOAMWR.js";
function k() {
	return (
		(k = Object.assign
			? Object.assign.bind()
...
class A extends V {
	constructor(e = {}) {
		...
		super(),
			...
			(this.onMouseEnter = async function (e) {
				if (e.target !== e.delegateTarget || !P()) return;
	...
	shouldPreload(e, { el: t } = {}) {
		...
		return !(
			...
			(t && this.swup.resolveUrl(s) === this.swup.resolveUrl(L()))
		);
	}
	async performPreload(e) {
		...
		return await this.swup.hooks.call(
			...
			async function (s, r) {
				return (
					(r.page = await t.swup.fetchPage(e, { visit: s })), r.page
				);
			}
		);
	}
