import { i as q } from "./index.B1fp56SV.js";
...
async function $(t, e, n, o, r) {
	...
	async function l(i) {
		...
		const v = dt(i.newDocument);
		v.length && !i.signal.aborted && (await Promise.all(v));
	}
	async function d() {
...
(P || ht() !== "none") &&
	...
	q({ prefetchAll: !0 }));
//# sourceMappingURL=ViewTransitions.astro_astro_type_script_index_0_lang.Czk30GG2.js.map
