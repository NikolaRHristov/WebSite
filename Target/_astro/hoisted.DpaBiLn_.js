...
(await v(() => import("./index.esm.CDbocLk8.js"), [])).initializeApp({
...
new (await v(() => import("./Swup.modern.DSkug2J8.js"), [])).default({
...
async function C(e, t, n, o) {
	const r = (s, u) => {
		...
		i = (s) => {
			...
			for (const c of g.querySelectorAll(`[${p}]`)) {
...
async function Q(e, t, n, o, r) {
	...
	if (((_ = !1), x))
		b = document.startViewTransition(async () => await C(l, o, r));
	else {
		const i = (async () => {
...
(x || Se() !== "none") &&
	...
	ve({ prefetchAll: !0 }));
//# sourceMappingURL=hoisted.DpaBiLn_.js.map
